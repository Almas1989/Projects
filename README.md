...
Portfolio of data engineering and analytics projects demonstrating ETL pipelines, stream processing, SQL analytics, and machine learning implementations.

---

## 📁 Projects Overview

## 1. 🔥 [PySpark Practice – Big Data Processing Guide](https://github.com/Almas1989/PySpark_colab_practice)
...
- **Skills**: `Spark DataFrames, SparkSQL, Window functions, UDFs, Caching/Persistence, Partitioning, Broadcast variables`

- **Stack**: PySpark, Python, Google Colab

---

## 2. 🎵 [Kafka Streaming Platform – Music Events Pipeline](https://github.com/Almas1989/kafka_de_project)
...
- **Skills**: `Stream processing, Event-driven architecture, Data Lake design, Real-time analytics, Batch processing, Parquet optimization`

- **Stack**: Kafka, Python, MinIO (S3), ClickHouse, Docker

---

## 3. 🌍 [Earthquake Data ETL Pipeline – Data Lakehouse](https://github.com/Almas1989/data_engineering_pp_1)
...
- **Skills**: `ETL design, Airflow orchestration, Medallion architecture, API integration, Data modeling, Docker containerization`

- **Stack**: Python, Apache Airflow, PostgreSQL, MinIO (S3), Docker, Metabase

---

## 4. 🧮 [SQL Analytics Practice – Salary Data Analysis](https://github.com/Almas1989/SQL_vs_pandas)
...
## 5. 🔍 [Data Cleaning & EDA – Layoffs Dataset](https://github.com/Almas1989/Projects/tree/main/EDA_MySQL)
...
## 6. 🎬 [Movie Correlation Analysis – Revenue Drivers](https://github.com/Almas1989/movie_corel)
...
## 7. 🧪 [A/B Testing – Marketing Campaign Evaluation](https://www.kaggle.com/code/almasscorp/ab-test)
...
## 8. 📈 [Cohort Analysis – E-commerce Retention](https://github.com/Almas1989/marketing_cohort_analysis)
...
## 9. 📂 [CSV Processor – Automated Data Pipeline](https://github.com/Almas1989/csv_processor)
...
- **Skills**: `Data preprocessing, File handling, ETL automation, Encoding management`

- **Stack**: Python, Pandas

---

## 10. 📚 [Wikipedia Parser – Async Scraper + AI Summarizer](https://github.com/Almas1989/wiki_parser)
...
- **Skills**: `Async programming, Web scraping, API development, AI integration, PostgreSQL`

- **Stack**: Python, FastAPI, SQLAlchemy, PostgreSQL, BeautifulSoup, DeepSeek API, Docker

---

## 11. 🍽️ [Restaurant Dish Detection – YOLOv11](https://github.com/Almas1989/comp_vision_proj)
...
- **Skills**: `Object detection, Dataset annotation, Model training, Data augmentation, Performance evaluation`

- **Stack**: Python, YOLOv11, OpenCV, LabelImg, Albumentations, PyTorch
